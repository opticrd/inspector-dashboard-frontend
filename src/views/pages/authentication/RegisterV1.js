...
import { Card, CardBody, CardTitle, CardText, Form, FormGroup, Label, Input, Button, Row, Col } from 'reactstrap'
        ...
        <Card className='mb-0'>
          <CardBody>
            <div className="d-flex justify-content-start align-items-end mt-2 mb-4">
              ...
              <h4 className='brand-text text-primary ml-1'>Reportero de la Gestión Gubernamental</h4>
            </div>
