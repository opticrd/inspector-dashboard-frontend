            ...
            <Row className='mt-1'>
                ...
                <Col lg='4' md='6'>
                    <FormGroup>
                        ...
                        <Input type='select' name='nacionalidad' id='nacionalidad' defaultValue='En progreso'>
                ...
                <Col lg='4' md='6'>
                    <FormGroup>
                        ...
                        <Input type='select' name='institucion' id='institucion' defaultValue='Seleccione'>
