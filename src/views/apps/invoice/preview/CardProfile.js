                  ...
                  <div className='d-flex justify-content-start'>
                      <div className='profile-image ml-3'>
                        <div className='profile-image'>
                           <img src={profileImg} className='img-fluid' width='50px' height='80px'/>
                        </div>
                      </div>
                  ...
                  <div className='user-avatar-section'>
                    <div className='d-flex justify-content-start'>
                        <div className='profile-image ml-5' >
                          <div className='profile-image'>
                            <Avatar img={profileImgPerson}  size ='lg' className='avatar-border box-shadow-1'/>
                          </div>
                        </div>
                      <div className='d-flex flex-column'>
                        <div className='user-info mb-1'>
                          <h4 className='mb-0 ml-1 text-left'>User Test</h4>
                          <small tag='span' className='ml-1 text-left text-primary font-weight-bolder'>
