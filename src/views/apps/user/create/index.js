...
import { Row, Col, Button, Label, FormGroup, Input, CustomInput, Form, Card, CardHeader, CardTitle, CardBody } from 'reactstrap'
...
const UserCreate = () => {
  ...
  return (
    <Card>
        <CardHeader>
          <CardTitle tag='h4'>Añadir Nuevo Usuario</CardTitle>
        </CardHeader>
        <CardBody>
            <Form
